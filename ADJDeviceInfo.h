...
@property (nonatomic,copy) NSString * installReceiptBase64;              //@synthesize installReceiptBase64=_installReceiptBase64 - In the implementation block
...
-(void)setInstallReceiptBase64:(NSString *)arg1 ;
